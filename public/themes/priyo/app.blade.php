...
<body>
    ...
    <div id="{{ Auth::check() ? '' : '' }}" class="nebula-theme flex flex-col">
        ...
        <div class="box_content container mx-auto min-h-tm-half order-2 bg-white md:rounded-md shadow-md flex flex-col md:space-x-2 justify-center z-10 {{ (isset($appPage) || (isset($page) && $page->mailbox == 1)) ? '-mt-16' : 'topmargin' }} -mb-16">
        ...
        <footer class="bg-blue-700 order-3 text-white text-center pt-20 pb-6 z-0" style="background-color: {{ config('app.settings.colors.primary') }}">
            ...
            <div class="copyright">
                ...
                <a target="_blank" href="https://play.google.com/store/apps/details?id=com.priosoft.priyomail"><img class="playstore-logo" src="{{ asset('assets/img/playstore.png') }}" alt=""></a>
            </div>
