    ...
    <x-jet-form-section submit="updateProfileInformation">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="recoveryMail" value="Recovery Mail" />
                <x-jet-input id="recoveryMail" type="email" class="mt-1 block w-full" wire:model.defer="state.recoveryMail" />
                <x-jet-input-error for="state.recoveryMail" class="mt-2" />
            </div>
        </x-slot>
    ...
    <x-jet-form-section submit="updatePassword">
        ...
        <x-slot name="form">
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input-error for="state.current_password" class="mt-2" />
            </div>
