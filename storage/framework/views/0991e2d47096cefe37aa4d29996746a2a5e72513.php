...
} elseif ($_instance->childHasBeenRendered('aiqFbTS')) {
    $componentId = $_instance->getRenderedChildComponentId('aiqFbTS');
    $componentTag = $_instance->getRenderedChildComponentTagName('aiqFbTS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aiqFbTS');
} else {
    $response = \Livewire\Livewire::mount('navigation-dropdown');
    $html = $response->html();
    $_instance->logRenderedChild('aiqFbTS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/rubyatin/priomail.rubyat.info/resources/views/layouts/app.blade.php ENDPATH**/ ?>