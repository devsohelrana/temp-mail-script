...
} elseif ($_instance->childHasBeenRendered('rxWi6nO')) {
    $componentId = $_instance->getRenderedChildComponentId('rxWi6nO');
    $componentTag = $_instance->getRenderedChildComponentTagName('rxWi6nO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rxWi6nO');
} else {
    $response = \Livewire\Livewire::mount('frontend.nav');
    $html = $response->html();
    $_instance->logRenderedChild('rxWi6nO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('MW2g175')) {
    $componentId = $_instance->getRenderedChildComponentId('MW2g175');
    $componentTag = $_instance->getRenderedChildComponentTagName('MW2g175');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MW2g175');
} else {
    $response = \Livewire\Livewire::mount('frontend.actions', ['in_app' => isset($page) ? true : false]);
    $html = $response->html();
    $_instance->logRenderedChild('MW2g175', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
} elseif ($_instance->childHasBeenRendered('sj1l0aW')) {
    $componentId = $_instance->getRenderedChildComponentId('sj1l0aW');
    $componentTag = $_instance->getRenderedChildComponentTagName('sj1l0aW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sj1l0aW');
} else {
    $response = \Livewire\Livewire::mount('frontend.page', ['page' => $page]);
    $html = $response->html();
    $_instance->logRenderedChild('sj1l0aW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php else: ?> 
...
} elseif ($_instance->childHasBeenRendered('6ub5ENj')) {
    $componentId = $_instance->getRenderedChildComponentId('6ub5ENj');
    $componentTag = $_instance->getRenderedChildComponentTagName('6ub5ENj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6ub5ENj');
} else {
    $response = \Livewire\Livewire::mount('frontend.app');
    $html = $response->html();
    $_instance->logRenderedChild('6ub5ENj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
</html><?php /**PATH D:\Laraverl Project\priyomail\resources\views/themes/nebula/app.blade.php ENDPATH**/ ?>