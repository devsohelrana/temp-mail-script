...
} elseif ($_instance->childHasBeenRendered('DntEVwB')) {
    $componentId = $_instance->getRenderedChildComponentId('DntEVwB');
    $componentTag = $_instance->getRenderedChildComponentTagName('DntEVwB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DntEVwB');
} else {
    $response = \Livewire\Livewire::mount('frontend.nav');
    $html = $response->html();
    $_instance->logRenderedChild('DntEVwB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('frontend.nav')->html();
} elseif ($_instance->childHasBeenRendered('eBZ4p6p')) {
    $componentId = $_instance->getRenderedChildComponentId('eBZ4p6p');
    $componentTag = $_instance->getRenderedChildComponentTagName('eBZ4p6p');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eBZ4p6p');
} else {
    $response = \Livewire\Livewire::mount('frontend.nav');
    $html = $response->html();
    $_instance->logRenderedChild('eBZ4p6p', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('p0m0rFW')) {
    $componentId = $_instance->getRenderedChildComponentId('p0m0rFW');
    $componentTag = $_instance->getRenderedChildComponentTagName('p0m0rFW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('p0m0rFW');
} else {
    $response = \Livewire\Livewire::mount('frontend.actions', ['in_app' => (isset($page) || isset($profile)) ? true : false]);
    $html = $response->html();
    $_instance->logRenderedChild('p0m0rFW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('VNZmCc2')) {
    $componentId = $_instance->getRenderedChildComponentId('VNZmCc2');
    $componentTag = $_instance->getRenderedChildComponentTagName('VNZmCc2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VNZmCc2');
} else {
    $response = \Livewire\Livewire::mount('frontend.page', ['page' => $page]);
    $html = $response->html();
    $_instance->logRenderedChild('VNZmCc2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php elseif(isset($profile)): ?>
...
} elseif ($_instance->childHasBeenRendered('5bfuwzi')) {
    $componentId = $_instance->getRenderedChildComponentId('5bfuwzi');
    $componentTag = $_instance->getRenderedChildComponentTagName('5bfuwzi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5bfuwzi');
} else {
    $response = \Livewire\Livewire::mount('frontend.profile', ['profile' => $profile]);
    $html = $response->html();
    $_instance->logRenderedChild('5bfuwzi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php elseif(isset($login)): ?>
...
} elseif ($_instance->childHasBeenRendered('K5mRuTe')) {
    $componentId = $_instance->getRenderedChildComponentId('K5mRuTe');
    $componentTag = $_instance->getRenderedChildComponentTagName('K5mRuTe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('K5mRuTe');
} else {
    $response = \Livewire\Livewire::mount('frontend.userlogin', ['login' => $login]);
    $html = $response->html();
    $_instance->logRenderedChild('K5mRuTe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php elseif(isset($signup)): ?>
...
} elseif ($_instance->childHasBeenRendered('JiRz2iI')) {
    $componentId = $_instance->getRenderedChildComponentId('JiRz2iI');
    $componentTag = $_instance->getRenderedChildComponentTagName('JiRz2iI');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JiRz2iI');
} else {
    $response = \Livewire\Livewire::mount('frontend.usersignup', ['signup' => $signup]);
    $html = $response->html();
    $_instance->logRenderedChild('JiRz2iI', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php else: ?> 
...
} elseif ($_instance->childHasBeenRendered('EWHKAgK')) {
    $componentId = $_instance->getRenderedChildComponentId('EWHKAgK');
    $componentTag = $_instance->getRenderedChildComponentTagName('EWHKAgK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EWHKAgK');
} else {
    $response = \Livewire\Livewire::mount('frontend.app');
    $html = $response->html();
    $_instance->logRenderedChild('EWHKAgK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
</html><?php /**PATH /var/www/vhosts/priyo.email/tempmail-best.com/resources/views/themes/priyo/app.blade.php ENDPATH**/ ?>