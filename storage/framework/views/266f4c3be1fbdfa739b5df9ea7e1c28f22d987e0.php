...
<div
    class="p-6 col-span-3 xl:col-span-1 bg-white dark:bg-dark-primary rounded-lg shadow-lg flex items-center gap-x-4">
    <div class="shrink-0">
...
<?php /**PATH D:\Laraverl Project\priyomail\resources\views/themes/priyonew/components/recentBlog.blade.php ENDPATH**/ ?>