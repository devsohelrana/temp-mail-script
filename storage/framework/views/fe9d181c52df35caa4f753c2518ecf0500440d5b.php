...
} elseif ($_instance->childHasBeenRendered('HPL4Gwj')) {
    $componentId = $_instance->getRenderedChildComponentId('HPL4Gwj');
    $componentTag = $_instance->getRenderedChildComponentTagName('HPL4Gwj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HPL4Gwj');
} else {
    $response = \Livewire\Livewire::mount('frontend.actions', ['in_app' => isset($page) ? true : false]);
    $html = $response->html();
    $_instance->logRenderedChild('HPL4Gwj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('8xqUk7V')) {
    $componentId = $_instance->getRenderedChildComponentId('8xqUk7V');
    $componentTag = $_instance->getRenderedChildComponentTagName('8xqUk7V');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8xqUk7V');
} else {
    $response = \Livewire\Livewire::mount('frontend.nav');
    $html = $response->html();
    $_instance->logRenderedChild('8xqUk7V', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('cHWH6o6')) {
    $componentId = $_instance->getRenderedChildComponentId('cHWH6o6');
    $componentTag = $_instance->getRenderedChildComponentTagName('cHWH6o6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cHWH6o6');
} else {
    $response = \Livewire\Livewire::mount('frontend.page', ['page' => $page]);
    $html = $response->html();
    $_instance->logRenderedChild('cHWH6o6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php else: ?> 
...
} elseif ($_instance->childHasBeenRendered('PEn5BO1')) {
    $componentId = $_instance->getRenderedChildComponentId('PEn5BO1');
    $componentTag = $_instance->getRenderedChildComponentTagName('PEn5BO1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PEn5BO1');
} else {
    $response = \Livewire\Livewire::mount('frontend.app');
    $html = $response->html();
    $_instance->logRenderedChild('PEn5BO1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
...
</html><?php /**PATH /Applications/MAMP/htdocs/prio.email/resources/views/themes/default/app.blade.php ENDPATH**/ ?>