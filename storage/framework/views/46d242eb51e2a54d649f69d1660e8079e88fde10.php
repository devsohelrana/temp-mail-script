            ...
            <?php if($initial): ?>
                ...
                <div x-show="!show" class="list">
                    <div class="head flex items-center gap-3 pt-5 pb-6 px-7 lg:rounded-t-md" style="background-color: <?php echo e(config('app.settings.colors.primary')); ?>20">
                        <div class="w-1/2 md:w-3/12"><?php echo e(__('Sender')); ?></div>
                        <div class="w-1/2 md:w-7/12"><?php echo e(__('Subject')); ?></div>
                        <div class="hidden md:flex md:w-2/12 justify-end"></div>
                    </div>
                    <div class="messages flex flex-col justify-end">

                        <div x-on:click="show = true; id = 99999999" class="flex items-center gap-3 hover:bg-gray-200 border-b border-dashed py-4 px-7 cursor-pointer">
                            <div class="w-1/2 md:w-3/12">
                                Priyo Email
                                <div class="text-xs overflow-ellipsis">info@priyo.email</div>
                            </div>
                            <div class="w-1/2 md:w-7/12">Welcome to Priyo Email</div>
                            <div class="hidden md:block w-full md:w-2/12">
                ...
                <div x-show="show" class="message">
                    <div x-show="id === 99999999" id="message-99999999" class="message min-h-tm-half">
                        ...
                        <div class="text-wrap py-4 px-7">
                            <div class="w-full flex flex-grow min-h-tm-half">
                                Hello, <br><br>

                                Congratulations on joining Priyo Email – your go-to platform for secure and temporary email services! We're excited to have you on board.
                                <br>
                                <br>
                                With Priyo Email, you can create disposable email addresses on the fly, giving you a quick and reliable way to receive emails without compromising your personal inbox. Whether you're signing up for online services, protecting your privacy, or just need a temporary email solution, we've got you covered.
                                <br> <br><br><br>
                                Thanks
                            </div>
            ...
            <?php else: ?>
                <div class="flex items-center min-h-tm-half">
                    <div class="flex-1 flex flex-col justify-center items-center text-gray-500 h-40">
                        <div class="text-lg"><?php echo e(__('Fetching') . '...'); ?></div>
                    </div>
                </div>
            <?php endif; ?>
...
</main><?php /**PATH /var/www/vhosts/priyo.email/tempmail-best.com/resources/views/themes/priyo/components/app.blade.php ENDPATH**/ ?>