...
} elseif ($_instance->childHasBeenRendered('Knlcf45')) {
    $componentId = $_instance->getRenderedChildComponentId('Knlcf45');
    $componentTag = $_instance->getRenderedChildComponentTagName('Knlcf45');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Knlcf45');
} else {
    $response = \Livewire\Livewire::mount('frontend.nav');
    $html = $response->html();
    $_instance->logRenderedChild('Knlcf45', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('frontend.nav')->html();
} elseif ($_instance->childHasBeenRendered('VYYvXZv')) {
    $componentId = $_instance->getRenderedChildComponentId('VYYvXZv');
    $componentTag = $_instance->getRenderedChildComponentTagName('VYYvXZv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VYYvXZv');
} else {
    $response = \Livewire\Livewire::mount('frontend.nav');
    $html = $response->html();
    $_instance->logRenderedChild('VYYvXZv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('QMDZZMb')) {
    $componentId = $_instance->getRenderedChildComponentId('QMDZZMb');
    $componentTag = $_instance->getRenderedChildComponentTagName('QMDZZMb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QMDZZMb');
} else {
    $response = \Livewire\Livewire::mount('frontend.actions', ['in_app' => ((isset($page) && $page->mailbox == 0) || isset($profile)) ? true : false]);
    $html = $response->html();
    $_instance->logRenderedChild('QMDZZMb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('JDkQbh3')) {
    $componentId = $_instance->getRenderedChildComponentId('JDkQbh3');
    $componentTag = $_instance->getRenderedChildComponentTagName('JDkQbh3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JDkQbh3');
} else {
    $response = \Livewire\Livewire::mount('frontend.app');
    $html = $response->html();
    $_instance->logRenderedChild('JDkQbh3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('SEQIzRU')) {
    $componentId = $_instance->getRenderedChildComponentId('SEQIzRU');
    $componentTag = $_instance->getRenderedChildComponentTagName('SEQIzRU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SEQIzRU');
} else {
    $response = \Livewire\Livewire::mount('frontend.page', ['page' => $page]);
    $html = $response->html();
    $_instance->logRenderedChild('SEQIzRU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('HG7lkMa')) {
    $componentId = $_instance->getRenderedChildComponentId('HG7lkMa');
    $componentTag = $_instance->getRenderedChildComponentTagName('HG7lkMa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HG7lkMa');
} else {
    $response = \Livewire\Livewire::mount('frontend.profile', ['profile' => $profile]);
    $html = $response->html();
    $_instance->logRenderedChild('HG7lkMa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php elseif(isset($login)): ?>
...
} elseif ($_instance->childHasBeenRendered('KK7o2nQ')) {
    $componentId = $_instance->getRenderedChildComponentId('KK7o2nQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('KK7o2nQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KK7o2nQ');
} else {
    $response = \Livewire\Livewire::mount('frontend.userlogin', ['login' => $login]);
    $html = $response->html();
    $_instance->logRenderedChild('KK7o2nQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php elseif(isset($signup)): ?>
...
} elseif ($_instance->childHasBeenRendered('zIvl82M')) {
    $componentId = $_instance->getRenderedChildComponentId('zIvl82M');
    $componentTag = $_instance->getRenderedChildComponentTagName('zIvl82M');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zIvl82M');
} else {
    $response = \Livewire\Livewire::mount('frontend.usersignup', ['signup' => $signup]);
    $html = $response->html();
    $_instance->logRenderedChild('zIvl82M', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php elseif(isset($blog)): ?>
...
} elseif ($_instance->childHasBeenRendered('heRTv33')) {
    $componentId = $_instance->getRenderedChildComponentId('heRTv33');
    $componentTag = $_instance->getRenderedChildComponentTagName('heRTv33');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('heRTv33');
} else {
    $response = \Livewire\Livewire::mount('frontend.blog', ['blog' => $blog]);
    $html = $response->html();
    $_instance->logRenderedChild('heRTv33', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php elseif(isset($blogDetails)): ?>
...
} elseif ($_instance->childHasBeenRendered('TOGvjxr')) {
    $componentId = $_instance->getRenderedChildComponentId('TOGvjxr');
    $componentTag = $_instance->getRenderedChildComponentTagName('TOGvjxr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TOGvjxr');
} else {
    $response = \Livewire\Livewire::mount('frontend.blogdetails', ['blogDetails' => $blogDetails]);
    $html = $response->html();
    $_instance->logRenderedChild('TOGvjxr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php else: ?> 
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('frontend.app')->html();
} elseif ($_instance->childHasBeenRendered('BkzjErr')) {
    $componentId = $_instance->getRenderedChildComponentId('BkzjErr');
    $componentTag = $_instance->getRenderedChildComponentTagName('BkzjErr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BkzjErr');
} else {
    $response = \Livewire\Livewire::mount('frontend.app');
    $html = $response->html();
    $_instance->logRenderedChild('BkzjErr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
</html><?php /**PATH /var/www/vhosts/tempmail-best.com/temporarymail.pro/resources/views/themes/priyo/app.blade.php ENDPATH**/ ?>