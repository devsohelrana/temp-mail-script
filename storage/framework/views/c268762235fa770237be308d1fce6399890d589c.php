                                 ...
                                 <?php $__env->slot('content', null, []); ?> 
                                    ...
                                    <div class="accountList">
                                        <?php $__currentLoopData = $emails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($item['email'] != $emailProfileName): ?>
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php $component->withAttributes(['href' => ''.e(route('switch', $item)).'']); ?>
                                                    <div class="flex min-w-0 gap-x-4">
                                                        <img class="h-8 w-8 rounded-full object-cover" src="<?php echo e($item['emailPic']); ?>" /> 
                                                        
                                                        <p class="text-sm font-semibold leading-6 text-gray-900"><?php echo e($item['email']); ?></p>
                                                    </div>
...
</nav><?php /**PATH /var/www/vhosts/priyo.email/tempmail-best.com/resources/views/themes/priyo/components/nav.blade.php ENDPATH**/ ?>