...
<body>
    <div class="softfinding-theme">
        <div class="flex flex-wrap">
            <div class="w-full lg:w-1/4 bg-blue-700 py-6 lg:min-h-screen"
...
} elseif ($_instance->childHasBeenRendered('Sj6B9SM')) {
    $componentId = $_instance->getRenderedChildComponentId('Sj6B9SM');
    $componentTag = $_instance->getRenderedChildComponentTagName('Sj6B9SM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Sj6B9SM');
} else {
    $response = \Livewire\Livewire::mount('frontend.actions', ['in_app' => isset($page) ? true : false]);
    $html = $response->html();
    $_instance->logRenderedChild('Sj6B9SM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('dF2TDtn')) {
    $componentId = $_instance->getRenderedChildComponentId('dF2TDtn');
    $componentTag = $_instance->getRenderedChildComponentTagName('dF2TDtn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dF2TDtn');
} else {
    $response = \Livewire\Livewire::mount('frontend.nav');
    $html = $response->html();
    $_instance->logRenderedChild('dF2TDtn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Qzfi6FJ')) {
    $componentId = $_instance->getRenderedChildComponentId('Qzfi6FJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('Qzfi6FJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Qzfi6FJ');
} else {
    $response = \Livewire\Livewire::mount('frontend.page', ['page' => $page]);
    $html = $response->html();
    $_instance->logRenderedChild('Qzfi6FJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php else: ?>
...
} elseif ($_instance->childHasBeenRendered('PuaAfel')) {
    $componentId = $_instance->getRenderedChildComponentId('PuaAfel');
    $componentTag = $_instance->getRenderedChildComponentTagName('PuaAfel');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PuaAfel');
} else {
    $response = \Livewire\Livewire::mount('frontend.app');
    $html = $response->html();
    $_instance->logRenderedChild('PuaAfel', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    <?php endif; ?>
