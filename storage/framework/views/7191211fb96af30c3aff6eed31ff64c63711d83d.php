...
} elseif ($_instance->childHasBeenRendered('sp73t4J')) {
    $componentId = $_instance->getRenderedChildComponentId('sp73t4J');
    $componentTag = $_instance->getRenderedChildComponentTagName('sp73t4J');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sp73t4J');
} else {
    $response = \Livewire\Livewire::mount('navigation-dropdown');
    $html = $response->html();
    $_instance->logRenderedChild('sp73t4J', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Applications/MAMP/htdocs/prio.email/resources/views/layouts/app.blade.php ENDPATH**/ ?>