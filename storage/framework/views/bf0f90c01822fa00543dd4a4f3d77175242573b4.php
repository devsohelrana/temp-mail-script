                        ...
                        <div class="messages flex flex-col justify-end">
                            <?php $__currentLoopData = $messages2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div x-on:click="show = true; id = <?php echo e($message['id']); ?>; document.querySelector('button.delete').setAttribute('wire:click', 'delete(<?php echo e($message['id']); ?>)')"
                                    class="flex items-center gap-3 hover:bg-gray-200 border-b border-dashed py-4 px-7 cursor-pointer <?php echo e($message['isRead'] ? 'mailRead':''); ?>"
                                ...
                                <div class="w-full flex justify-between items-center">
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <button
                                            ...
                                            class="delete border-b" wire:click="delete(<?php echo e($message['id']); ?>)"><?php echo e(__('Delete')); ?></button>
                                    </div>
                                </div>
                            </div>
                            <div class="message min-h-tm-half">
                                <textarea
            ...
            <?php if($initial): ?>
                ...
                <div x-show="!show" class="list">
                    ...
                    <div class="messages flex flex-col justify-end">
                        ...
                        <div x-on:click="show = true; id = 99999999" class="flex items-center gap-3 hover:bg-gray-200 border-b border-dashed py-4 px-7 cursor-pointer">
                            <div class="w-1/2 md:w-3/12">
                                <?php echo e(config('app.settings.mailName')); ?>

                                <div class="text-xs overflow-ellipsis"><?php echo e(config('app.settings.mailFrom')); ?></div>
                            </div>
                            <div class="w-1/2 md:w-7/12"><?php echo e(config('app.settings.mailSubject')); ?></div>
                            <div class="hidden md:block w-full md:w-2/12">
                ...
                <div x-show="show" class="message">
                    <div x-show="id === 99999999" id="message-99999999" class="message min-h-tm-half">
                        ...
                        <div class="border-t border-b border-dashed py-4 px-7">
                            <?php echo e(config('app.settings.mailFrom')); ?>

                        </div>
                        <div class="text-wrap py-4 px-7">
                            <div class="w-full flex flex-grow min-h-tm-half">
                                <?php echo nl2br(config('app.settings.mailDetails')); ?>
...
</main><?php /**PATH /home/cowt7s/domains/correo-temporal.com/public_html/resources/views/themes/priyo/components/app.blade.php ENDPATH**/ ?>