<div class="grid grid-cols-6 gap-6">
    ...
    @elseif($current === 2)
        ...
        <div class="col-span-6">
            ...
            <div class="relative">
                <select class="form-input rounded-md shadow-sm mt-1 block w-full cursor-pointer" wire:model="state.engine">
                    ...
                    <option value="delivery">{{ __('Priyo Mail Delivery') }}</option>
        ...
        <div class="col-span-6 -mt-3">
            <p class="text-gray-600 text-sm">{{ __('You can continue the Priyo Mail Delivery setup later by logging into Admin Panel') }}</p>
        </div>
