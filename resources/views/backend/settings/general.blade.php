<x-jet-form-section submit="update">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input-error for="state.language" class="mt-2" />
            <small>{{ __('Priyo Mail will use this to remove your site footprint being passed-on to external link.') }}</small>
        </div>
        <div id="ad-block-detector" class="col-span-6">
            ...
            <small>{{ __('If you enable this, then Priyo Mail block all the users from using Priyo Mail that have Ad Blocker enabled.') }}</small>
        </div>
        <div class="col-span-6 sm:col-span-4">
            <div class="mb-4">
