        ...
        <div class="col-span-6">
            ...
            <div class="flex">
                <div>
                    ...
                    <x-jet-input type="text" class="mt-1 block w-full" wire:model.defer="state.theme_options.button.text" placeholder="" />
                </div>
                <div class="ml-2 flex-1">
                    <x-jet-label for="drax_btn_link" value="{{ __('Link') }}" />
                    <x-jet-input type="text" class="mt-1 block w-full" wire:model.defer="state.theme_options.button.link" placeholder="" />
                </div>
            </div>
        </div>
        @endif
