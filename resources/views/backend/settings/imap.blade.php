<x-jet-form-section submit="update">
    ...
    <x-slot name="description">
        {{ __('IMAP Settings for internal or external server from which Priyo Mail will fetch emails.') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <small>{{ __('If enabled Priyo Mail will check the CC field as well while fetching mails.') }}</small>
        </div>
    </x-slot>
