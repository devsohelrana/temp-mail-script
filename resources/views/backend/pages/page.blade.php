    ...
    <x-slot name="form">
        @if($addPage || $updatePage)
            ...
            <div class="col-span-6">
                ...
                <div class="mt-1"><div class="hidden" id="quill-content">{!! (!$addPage) ? $page['content'] : '' !!}</div></div>
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-jet-label for="mailbox" value="{{ __('Mailbox') }} ({{ __('Mailbox') }})" />
                <div class="relative">
                ...
                <x-jet-input-error for="page.mailbox" class="mt-2" />
            </div>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input id="seo_title" type="text" class="mt-1 block w-full" placeholder="Meta Title" wire:model.defer="page.seo_title"/>
                <x-jet-input-error for="page.seo_title" class="mt-2" />
            </div>
            <div class="col-span-6">
                ...
                <x-jet-input-error for="page.seo_keyword" class="mt-2" />
            </div>
            ...
            <div class="col-span-6">
                ...
                <x-jet-input-error for="page.seo_description" class="mt-2" />
            </div>
