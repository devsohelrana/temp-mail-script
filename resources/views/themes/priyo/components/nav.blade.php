                            ...
                            <x-jet-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button
                                        ...
                                        <img loading="lazy" width="32" height="32" class="h-8 w-8 rounded-full object-cover" src="{{ asset('images/profile_pic.png?var=1.7') }}"
                                            alt="{{ (Auth::check()) ? Auth::user()->name : 'profile' }}" />
                                    </button>
                                </x-slot>
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-jet-dropdown-link href="/permanent-mail-profile">
                                    ...
                                    <x-jet-dropdown-link href="/permanent-mail-login">
                                    ...
                                    <x-jet-dropdown-link href="/permanent-mail-signup">
